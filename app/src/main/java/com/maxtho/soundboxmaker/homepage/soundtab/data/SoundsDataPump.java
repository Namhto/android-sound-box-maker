...
public class SoundsDataPump {
    ...
    public static List<SoundCategorie> getListData() {
        ...
        SoundCategorie animaux = new SoundCategorie().setTitle("Animaux").setSoundList(Arrays.asList(s1));
        SoundCategorie armes = new SoundCategorie().setTitle("Armes").setSoundList(Arrays.asList(s2));
        SoundCategorie lopez = new SoundCategorie().setTitle("Lopez").setSoundList(Arrays.asList(s3, s4, s5, s6, s7, s8, s9));

        listDetail.add(animaux);
        listDetail.add(armes);
        listDetail.add(lopez);
